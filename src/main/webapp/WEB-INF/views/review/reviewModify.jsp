				...
				<div class="row">
					<div class="my-4 col-md-8 mx-auto">
						<div id="rating" class="review_form contact-form">
							<form action="/review/reviewModify" id="reviewModify"
								...
								<div class="form-group">
									...
									<div class="form-group col-md-6">
										...
										<textarea class="form-control" id="rew_content"
											name="rew_content" rows="5" required><c:out
												value="${ReviewVO.rew_content}" /></textarea>
									</div>
									<div class="form-group">
										<div class="col-md-4">
											<label for="upload">사진 첨부</label> <input type="file"
												id="upload" name="upload">
											<!-- 이미지 변경시 기존이미지정보를 이용하여 기존이미지 삭제, 이미지 변경 안하면, 기존이미지 정보를 수정데이타로 사용 -->
											<input type="hidden" name="rew_uploadpath"
												value="<c:out value='${ReviewVO.rew_uploadpath}' />">
											<input type="hidden" name="rew_img"
												value="<c:out value='${ReviewVO.rew_img}'/>">
										</div>
									</div>
									<div class="form-group">
										<div class="col-md-4">
											<label for="upload">미리보기</label> <img name="reviewImage"
												id="previewImage"
												src="/review/displayFile?fileName=s_<c:out value='${ReviewVO.rew_img}'/>&uploadPath=<c:out value='${ReviewVO.rew_uploadpath}'/>">
										</div>
										<div class="col-md-4">
								...
								<input type="hidden" id="rew_num" name="rew_num"
									value="${ReviewVO.rew_num }"> <input type="hidden"
									id="ord_code" name="ord_code" value="${ReviewVO.ord_code }">
								<input type="hidden" id="pro_num" name="pro_num"
									value="${ReviewVO.pro_num }"> <input type="hidden"
									id="pageNum" name="pageNum" value="${cri.pageNum }"> <input
									type="hidden" id="amount" name="amount" value="${cri.amount }">
								<div class="row">
									<div class="col-md-6">
										<button type="submit" id="btnReviewAdd"
											class="btn btn-primary form-control">상품후기수정</button>
									</div>
									<div class="col-md-6">
										<button type="button" id="btnReviewDel"
											class="btn btn-danger form-control">상품후기삭제</button>
									</div>
								</div>
							</form>
						</div>
