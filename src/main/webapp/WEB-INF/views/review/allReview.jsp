	...
	<div class="container">
		...
		<div class="reviews_index__head">
			...
			<div class="filter_sort_basic menu">
				<ul
					class="filter_sort_basic__sort_search_list filter_sort_basic__sort_search_list--review_searchable">
					<li class="filter_sort_basic__sort">

						<div class="filter_sort_basic menu">
							<ul
								class="orderby filter_sort_basic__sort_search_list filter_sort_basic__sort_search_list--review_searchable">
								<li
									class="orderbyItem filter_sort_basic__sort_list_item js-review-sort-list-item">
					...
					<li
						class="filter_sort_basic__search js-filter-search-component js-search-toggle">
						<div class="filter_sort_basic__search_input_container">
							<div class="input-group mb-3">
								<input type="text" class="form-control" id="rew_search"
									name="keyword" placeholder="리뷰 키워드 또는 상품 검색"
									value="<c:out value="${con.keyword}" />">
								<div class="input-group-append">
									<button class="btn btn-light" type="button">
										<img height="10px" src="/img/search_close.png">
									</button>
								</div>
							</div>
						</div>
					...
					<ul class="filter_sort_basic__filter_list js-filter-list">
						<li class="filter_sort_basic__filter">
							<div class="dropdown form-control">
								<select class="dropdown-toggle" id="category"
									data-toggle="dropdown" aria-haspopup="true"
									aria-expanded="false">
									<option value="">전체 카테고리</option>
									<c:forEach items="${userCategory}" var="categoryVO">
										<option class="dropdown-item" value="${categoryVO.cate_code}"
							...
							<div class="dropdown form-control">
								...
								<div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
									...
									<div class="dropdown-item">
										<span>★★★★★ </span><label for="rating-5">아주 좋아요</label> <input
											data-score="5" type="checkbox" id="rating-5">
									</div>
									<div class="dropdown-item">
										<span>★★★★☆ </span><label for="rating-4">맘에 들어요</label> <input
											data-score="4" type="checkbox" id="rating-4">
									</div>
									<div class="dropdown-item">
										<span>★★★☆☆ </span><label for="rating-3">보통이예요</label> <input
											data-score="3" type="checkbox" id="rating-3">
									</div>
									<div class="dropdown-item">
										<span>★★☆☆☆ </span><label for="rating-2">그냥 그래요</label> <input
											data-score="2" type="checkbox" id="rating-2">
									</div>
									<div class="dropdown-item">
										<span>★☆☆☆☆</span><label for="rating-1">별로예요</label> <input
											data-score="1" type="checkbox" id="rating-1">
									</div>
									<c:set var="scoreStr"
										value="${empty con.scores ? '' : fn:join(con.scores, ',')}" />
									<input type="hidden" id="rew_scores" name="scores"
										value="${scoreStr}">
		...
		<div>
			<ul>
				<c:forEach items="${reviewListVO }" var="reviewVO"
					varStatus="status">
					<li
						class="review_list_v2 review_list_v2--collapsed renewed_review renewed_review--comments_expanded js-review-container"
						data-message-initial-rows="3" data-review-content-height="54"
						data-nonmember-review-check-edit-url="/pethooh.com/nonmember_reviews/edit_popup?id=26111&amp;widget_env=100&amp;widget_id=1"
						data-nonmember-review-check-delete-url="/pethooh.com/nonmember_reviews/delete_popup?id=26111&amp;widget_env=100"
						id="review_26111">
								...
								<div class="src_section review_list_v2__score_section">
									<div class="review_list_v2__score_container">
										<div class="review_list_v2__score_star">
											<input type="hidden" name="rew_num"
												value="${reviewVO.rew_num }">
											별점.${reviewVO.rew_score } <input type="hidden"
												name="rew_score" value="${reviewVO.rew_score }">
											<c:set var="star" />
											<c:choose>
											...
											<span class="review_list_v2__score"><c:out
													value="${star }" /></span>
										</div>
									...
									<div class="review_list_v2__product_section ">
										<a href="${reviewVO.pro_num }" class="proDetail">
											<div class="review_list_v2__product_container">
												<div class="review_list_v2__product_image_container">
													<img
														class="review_list_v2__product_image js-review-media smooth"
														name="proImage" id="pro_img" width="100%" height="225"
														src="/product/displayFile?fileName=s_<c:out value="${reviewVO.pro_img }"></c:out>&uploadPath=<c:out value="${reviewVO.pro_uploadpath }"></c:out>">
												</div>
												<div class="review_list_v2__info_container">
													<input type="hidden" name="pro_num" id="pro_num"
														value="${reviewVO.pro_num }">
													...
													<div class="review_list_v2__review_info">
														<span class="review_list_v2__score_icon"></span> <span
															class="review_list_v2__score" style="color: #ffd500cf">평균별점
															★ ${reviewVO.pro_rewrating }</span> <span
															class="review_list_v2__reviews_count"> 리뷰
															${reviewVO.pro_rewcount }</span>
													</div>
												</div>
											</div>
										</a>
									...
									<div class="review_list_v2__content_section">
										<div
											...
											<div
												class="review_list_v2__content review_content__collapsed">
												<div class="review_list_v2__message_container">
													<div
														class="review_list_v2__expand_link js-renewal-review-message-link js-renewal-link-expand disabled">
														<div
									...
									<div class="review_list_v2__image_section">
										<div class="review_media_v2">
											<ul class="review_media_v2__media">
												<li class="review_media_v2__medium"><c:if
														test="${reviewVO.rew_img != null && reviewVO.rew_img != ''}">
														<div class="img_boxing">
															<img
																class="rew_img_src review_media_v2__medium_image js-review-media smooth"
																name="reviewImage"
