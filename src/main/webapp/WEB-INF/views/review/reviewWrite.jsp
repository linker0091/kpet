				...
				<div class="row">
					<div class="my-4 col-md-8 mx-auto">
						<div id="rating" class="review_form contact-form">
							<form id="rewWriteAction" action="/review/reviewWrite"
								...
								<div class="form-group">
									...
									<div class="form-group col-md-6">
										...
										<textarea class="form-control" id="rew_content"
											name="rew_content" rows="5" required></textarea>
									</div>
									<div class="form-group">
										<div class="col-md-4">
									...
									<div class="form-group">
										<div class="col-md-4">
											<label for="upload">미리보기</label> <img alt="" src=""
												id="previewImage">
										</div>
										<div class="col-md-4">
								...
								<input type="hidden" id="user_id" name=""> <input
									type="hidden" id="rew_score" name="rew_score"> <input
									type="hidden" id="pro_num" name="pro_num" value="${pro_num }">
								<input type="hidden" id="ord_code" name="ord_code"
									value="${ord_code }"> <input type="hidden" id="pageNum"
									name="pageNum" value="${cri.pageNum }"> <input
									type="hidden" id="amount" name="amount" value="${cri.amount }">
								<button type="button" id="btnReviewAdd"
									class="btn btn-primary form-control">상품후기등록</button>
							</form>
						</div>
					</div>
				</div>
