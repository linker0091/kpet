...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
 ...
 <li class="review_media_medium">
 	<img height="120" name="reviewImage" src="/review/displayFile?fileName=s_<c:out value="${reviewVO.rew_img }"></c:out>&uploadPath=<c:out value="${reviewVO.rew_uploadpath }"></c:out>">
 </li>
 </c:forEach>
 </ul>
 </div>
 ...
 <div class="product_review_inline-flex">
 별점
 </div>
