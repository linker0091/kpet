			...
			<form class="joinForm" action="/user/join" method="post"
				...
				<div class="form-group">
					<label for="user_pw">비밀번호</label> <input type="password"
						class="form-control" id="user_pw" name="user_pw"> <small
						id="password-message" class="form-text"></small>
				</div>
				<div class="form-group">
					<label for="confirm_pw">비밀번호 확인</label> <input type="password"
				...
				<div class="form-row">
					...
					<div class="col-md-2">
						<label for="auth_mail">메일인증코드입력</label> <input type="text"
							class="form-control" id="auth_mail" name="auth_mail">
					</div>
					<div class="col-md-2">
				...
				<div class="form-row">
					...
					<div class="col-md-2">
						<label for="btnPostCode">&nbsp;</label> <input type="button"
							class="form-control" id="btnPostCode" name="btnPostCode"
							value="우편번호찾기" onclick="sample2_execDaumPostcode()">
					</div>
				</div>
				...
				<div class="form-group form-check">
					<input type="checkbox" class="form-check-input" id="user_emailrec"
						name="user_emailrec" value="Y"> <label
						class="form-check-label" for="user_emailrec">메일수신여부</label>
				</div>
