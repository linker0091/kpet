				...
				<ul class="clearfix">
					<c:forEach items="${userCategory}" var="categoryVO">
						<li class="nav-item dropdown">
							<!-- 1차 카테 --> <a class="nav-link category_menu"
							data-toggle="dropdown" href="${categoryVO.cate_code }"
							role="button">${categoryVO.cate_name }</a> <!-- drop박스 -->
							<div class="drop clearfix">
								<!-- 2차 카테 -->
								<div class="depth2">
									<ul class="subCategory depth2_subbox clearfix"
					...
					<li class="nav-item"><a class="nav-link category_menu"
						href="/review/allReview">리얼리뷰</a></li>
				</ul>
				<div class="right_icon_menu">
					<ul>
						<!-- 날씨 api 추가 -->
						<li id="weather" style="font-size: 15px;"></li>
						<li><a href="#" class="into_search_btn">검색 <img
								src="/img/ico_search.png">
						</a></li>
						<li><a href="/user/mypage">마이페이지 <img
								src="/img/ico_mypage.png">
						</a>
							<ul class="top_login">
								<!-- 상품리뷰 최근알림 -->
								<c:if test="${sessionScope.loginStatus == null }">
									<li class=""><a href="/user/login">로그인</a></li>
									<li class=""><a href="/user/join">회원가입</a></li>
								</c:if>
								<c:if test="${sessionScope.loginStatus != null }">
									<li><a href="/user/logout">로그아웃</a></li>
								...
								<li><a href="/consult/cstList">1:1 맞춤상담</a></li>
							</ul></li>
						<li><a href="/cart/cartList">장바구니 <img
								src="/img/ico_cart.png"> <span class="cartTotal">0</span>
						</a></li>
					</ul>
				</div>
			</div>
...
<div class="search_area">
	<a href="#" class="closebtn"> <img src="/img/search_close.png">
	</a>
	<div class="inner_box">
		<h1>
			고객님<br>무엇을 찾으세요?
		...
		<div class="search_box">
			<form id="searchForm" action="/product/productSearchList"
				method="get">
				<input type="text" class="search" id="search" name="keyword"
					placeholder="검색어를 입력해주세요."></input> <input type="hidden"
					class="search" name="orderby"></input> <img id="search_img"
					class="sch_button" src="/img/top_search_b.png" alt="검색"
					class="search_cont">
			</form>
		</div>
		<p>인기검색어</p>
