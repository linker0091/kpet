...
<%@ include file="/WEB-INF/views/user/include/plugin_js.jsp" %>
 ...
 <!-- Header-->
   ...
   <div class="container header-top">
    ...
    <c:if test="${sessionScope.loginStatus != null }">
       ...
       <a class="p-2 text-dark" href="/cart/cartList">
 ...
 <!-- Navigation-->
            <div class="brand container">
                ...
                <img src="bird.jpg" alt="Logo" style="width:40px;"></a> -->
      ...
      <c:forEach items="${userCategory}" var="categoryVO">
        <li class="nav-item dropdown">
              <a class="nav-link" id="navbarDropdown" href="${categoryVO.cate_code }"  role="button"data-bs-toggle="dropdown" aria-expanded="false">${categoryVO.cate_name }</a>
          <div class="subCategory" id="subCategory_${categoryVO.cate_code }"></div>
</li>
     </c:forEach>
    </ul>
    <div class="navbar-nav">
      <a class="nav-link" href=""  role="button">이벤트</a>
              <a class="nav-link" href="/review/allProductReview"  role="button">리뷰</a>
