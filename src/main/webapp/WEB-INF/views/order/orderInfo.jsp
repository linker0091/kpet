...
<html>
  <head>
    ...
    <style>
      ...
      #btn_kakaopay { opacity:0.8; }
      #btn_kakaopay:hover {  opacity: 1; }
...
<div class="container">
			...
			<tbody>
				...
				<c:forEach items="${orderInfo }" var="orderInfoVO" varStatus="status">
					<tr role="row"
						...
						<td>
							<input type="text" id="pro_name" value='<c:out value="${orderInfoVO.pro_name }"></c:out>' readonly>
							<input type="hidden" name="orderDetailList[${status.index }].pro_num" value='<c:out value="${orderInfoVO.pro_num }"></c:out>'>
						</td>
						<td>
							<input type="text" name="orderDetailList[${status.index }].dt_ord_amount" value='<c:out value="${orderInfoVO.cart_amount }"></c:out>' readonly>
						...
						<td>
								<input type="text" class="order_price" name="orderDetailList[${status.index }].dt_ord_price" value='<c:out value="${orderInfoVO.orderprice }"></c:out>'>
						</td>
						
					</tr>
				</c:forEach>
					<tr>
						<td colspan="5">주문 총합계 : <input type="text" name="ord_price" id="ord_price" readonly></td>
					</tr>
  ...
  <div class="form-row">
	...
	<div class="col-md-10">
	    <input type="text" style="width: 500px" id="user_name" name="user_name" value="${sessionScope.loginStatus.user_name}" readonly>
	</div>
	<div class="col-md-2">
	    <label for="user_email">이메일</label>
	</div>
	<div class="col-md-10">
	    <input type="text" style="width: 500px" id="user_email" name="user_email" value="${sessionScope.loginStatus.user_email}">
	...
	<div class="col-md-10">
	    <input type="text" style="width: 500px" id="user_phone" name="user_phone" value="${sessionScope.loginStatus.user_phone}">
	</div>
	<div class="col-md-2">
	    <label for="user_addr">주소</label>
	</div>
	<div class="col-md-10">
	    <input type="text" style="width: 250px" id="user_addr" name="user_addr" value="${sessionScope.loginStatus.user_addr}"> -
	    <input type="text" style="width: 250px" id="user_deaddr" name="user_deaddr" value="${sessionScope.loginStatus.user_deaddr}">
	        우편번호
	    <input type="text" style="width: 250px" id="user_postcode" name="user_postcode" value="${sessionScope.loginStatus.user_postcode}">
	</div>
  </div>
  <br><br><br>
  <h5>배송 정보</h5>
  ...
  <div class="form-row">
	...
	<div class="col-md-10">
	    <input type="text" style="width: 250px" id="ord_phone" name="ord_phone">
	</div>
	<div class="col-md-2">
	...
	<div class="col-md-10">
	    ...
	    <input type="text" style="width: 250px" id="ord_addr_detail" name="ord_addr_detail">
	    	우편번호
	    <input type="text" style="width: 250px" id="ord_postcode" name="ord_postcode">
	</div>
	<div class="col-md-2">
	...
	<div class="col-md-12">
	    <input type="button" class="ord_btn" style="width: 250px; height: 47px; margin: 42px 10px;" value="주문하기">
   		<img src="/resources/img/payment_icon_yellow_small.png" id="btn_kakaopay" style="cursor:pointer; width: 250px; margin: 42px 10px;">
	    <input type="button" class="orderCancel" style="width: 250px; height: 47px; margin: 42px 10px;" value="주문취소">
	</div>
  </div>
  </c:if>
</form>
