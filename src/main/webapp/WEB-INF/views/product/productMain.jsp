		  ...
		  <div class="slider">
		  	<a href="#">
				<div class="main_txt">
            		...
            		<div class="t1">첫 구매시<br><strong>인기 상품이 0원</strong></div>
            		<div class="t2">신규회원 체험 이벤트</div>
				</div>
				<img src="img/banner_visual_83.jpg" alt="">
			</a>
		  </div>
		  <div class="slider">
		  	<a href="#">
		  		<div class="main_txt">
            		...
            		<div class="t1">Kpet Dr.HOOH<br><strong>맞춤솔루션 동결건조 트릿</strong></div>
            		<div class="t2">유산균/관절 케어/덴탈 케어</div>
				</div>
				<img src="img/banner_visual_101.jpg" alt="">
			</a>
		  </div>
		  <div class="slider">
		  	<a href="#">
		  		<div class="main_txt">
            		...
            		<div class="t1">휴먼그레이드 맞춤솔루션<br><strong>관절건강 오리</strong></div>
            		<div class="t2">강아지 전연령</div>
				</div>
				<img src="img/banner_visual_109.jpg" alt="">
			</a>
		  </div>
		  <div class="slider">
		  	<a href="#">
		  		<div class="main_txt">
            		...
            		<div class="t1">휴먼그레이드<br><strong>펫후 TRUE 심쿵츄르</strong></div>
            		<div class="t2">닭고기&amp;참치 / 닭고기&amp;호박</div>
				</div>
				<img src="img/banner_visual_114.jpg" alt="">
			</a>
		  </div>
		  <div class="slider">
		  	<a href="#">
				...
				<img src="img/banner_visual_117.jpg" alt="">
			</a>
		  </div>
		  <div class="slider">
		  	<a href="#">
				...
				<img src="img/banner_visual_121.jpg" alt="">
			</a>
		  </div>
	  </div>
	</div>
