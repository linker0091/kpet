...
.tabnav li a.tab_active:before{background:#7ea21e;}
.tabnav li a.tab_active{border-bottom:1px solid #fff;}
.tabnav li a{ position:relative; display:block; background: #f8f8f8; color: #000; padding:0 30px; line-height:46px; text-decoration:none; font-size:16px;}
.tabnav li a:hover,
.tabnav li a.tab_active{background:#fff; color:#7ea21e; }
...
.tab_active{    border: 2px solid #111;
    border-bottom: 2px solid #fff; color: #202020; }
.content{display: none; height: max-content; padding-top: 78px; }
.on{display: block !important;}

#contents1 img { display: block; margin: 0 auto; width: 75%; }
...
<div class="container product-detail">
      ...
      <div class="row">
 		...
 		<span class="product-name">${productVO.pro_name }</span>
      	...
      	<tr id="sum_price_tr">
      	<td>총 상품금액 : <span class="sum_price"></span>원</td>
      ...
      <div class="ck_simple_info"><h2>상품설명</h2>${productVO.pro_content }</div>
	...
	<div class="container">
	  <div class="tab">
        <div class="flex">        	
            <a href="#" class="panel tab_active">상세정보</a>
            <a href="#" class="panel product_review_tab">리얼리뷰</a>
            <a href="#" class="panel">상품문의</a>
	    ...
	    <div id="contents2" class="product_review content">
	        	컨텐츠 2
	    </div>
	    <div id="contents3" class="product_consult content">
	        	<a href="/user/consult">상품문의 하기</a>
	    </div>
  ...
  //합계 계산
   ...
   $(".product_review_tab").on("click", function(){
     var pageNum = $('#rewPageNum').val();
     var amount = $('#rewAmount').val();
