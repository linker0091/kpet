...
<div class="container">
      ...
      <div class="row">
      <c:forEach items="${lastProductList }" var="productVO" varStatus="status">
        <div class="col-md-3">
      ...
      <div class="row">
      	...
      	<div class="col-sm-2">								
			<div class="dataTables_paginate paging_simple_numbers" id="example2_paginate">
				<ul class="pagination">
				<c:if test="${lastPageMaker.prev }">
					<li class='paginate_button previous ${lastPageMaker.prev ? "": "disabled" }'
						id="example2_previous"><a href="${lastPageMaker.startPage - 1}"
						aria-controls="example2" data-dt-idx="0" tabindex="0">Previous</a></li>
				</c:if>
				<c:forEach begin="${lastPageMaker.startPage }" end="${lastPageMaker.endPage }" var="num">	
					<li class='paginate_button ${lastPageMaker.cri.pageNum == num ? "active":"" }'><a href="${num}"
						aria-controls="example2" data-dt-idx="1" tabindex="0">${num}</a></li>
				</c:forEach>
				<c:if test="${lastPageMaker.next }">	
					<li class="paginate_button next" id="example2_next"><a
						href="${lastPageMaker.endPage + 1}" aria-controls="example2" data-dt-idx="7"
		...
		<form id="actionForm" action="/product/productFinallSubList" method="get">
			<!--list.jsp 가 처음 실행되었을 때 pageNum의 값을 사용자가 선택한 번호의 값으로 변경-->
			<input type="hidden" name="pageNum" value="${lastPageMaker.cri.pageNum}">
			<input type="hidden" name="amount" value="${lastPageMaker.cri.amount}">
