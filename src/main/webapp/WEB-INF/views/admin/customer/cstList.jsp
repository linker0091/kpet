...
<body class="hold-transition skin-blue sidebar-mini">
	...
	<div class="wrapper">
        ...
        -------------------------->
				<form action="/admin/adminRegister" method="post" id="adminForm">
					<div class="form-row">
						<input type="button" value="접수중[${cst_answer_n}]"
							data-ans_state="N" name="cst_answer"> <input
							type="button" value="답변완료[${cst_answer_y}]" data-ans_state="Y"
							name="cst_answer">
					</div>
	...
	<script>
		...
		$(".sonsult").on("click", function(e) {
			...
			let urlN = "/admin/consult/cstRead?cst_num=" + num;
			location.href = urlN;
		});
		...
		$("input[name='cst_answer']").on("click", function() {
			...
			location.href = "/admin/consult/cstList?cst_answer=" + ans_state;
		});
