...
<body class="hold-transition skin-blue sidebar-mini">
				...
				<div class="consult_wrap consult_inner">
					<div class="consult_box">
						...
						<c:if test="${cstInner.cst_answer eq 'N'}">
							<form action="/admin/consult/writeAnswer" method="post"
								id="adminForm">
								<div class="consult_wrap clearfix">
									...
									<div class="consult_writebox">
										<!-- 상담 글쓰기 페이지 -->
										<div class="title_box">
											<input type="hidden" name="cst_num"
												value="${cstInner.cst_num}">
											<ul class="clearfix">
												<li class="answerName">답변자</li>
												<li><input type="text" name="ad_id"
													class="inputTypeText"
													value="<c:out value='${sessionScope.adminStatus.ad_id}' />">
												</li>
											</ul>
											<ul class="clearfix">
												<li class="answerName">제목</li>
												<li><input type="text" name="ans_title"
													class="inputTypeText" value="문의 답변입니다."></li>
											</ul>
										</div>
										<div class="title_box write_inner">
											<ul class="clearfix">
												<li>내용</li>
												<textarea id="ans_content" type="text" class="write_text"
													name="ans_content" rows="10" cols="80"></textarea>
											</ul>
										</div>
									</div>
									<input type="hidden" name="cst_answer"
										value="${cstInner.cst_answer}">
	...
	<script>
		...
		$(".cst_answerbtn")
				.on(
						...
						function() {
							...
							console.log(cst_num);
							adminForm
									.append("<input type='hidden' name='cst_num' value='" + cst_num + "'>");
		...
		$(".cst_listbtn").on(
				"click",
				function() {
					location.href = "/admin/consult/cstList";
					let cst_answer = $(".answerVal").text();
					;
					if (cst_answer != 'N') {
						location.href = "/admin/consult/cstList?cst_answer="
								+ cst_answer;
					}
					;
				});
