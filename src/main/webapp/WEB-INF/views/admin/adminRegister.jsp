...
<div class="wrapper">
  ...
  <div class="content-wrapper">
	...
	<form action="/admin/adminRegister" method="post" id="adminForm">
		<div class="form-row">
		    <div class="col-md-5">
		      <label for="ad_id">관리자 ID</label>
		      <input type="text" class="form-control" id="ad_id" name="ad_id">
		    </div>
		    <div class="col-md-5">
		      <label for="ad_pw">관리자 PW</label>
		      <input type="password" class="form-control" id="ad_pw" name="ad_pw">
		    </div>
		    <div class="col-md-5">
		      <label for="ad_pw">관리자 NAME</label>
		      <input type="text" class="form-control" id="ad_name" name="ad_name">
		    </div>
		      <input type="hidden" class="form-control" id="ad_position" name="ad_position" value="신청중">
		    <div class="col-md-2">
		      <label for="ad_user">&nbsp;</label>
		      <input type="submit" class="form-control" id="ad_user" value="관리자 신청">
		    </div>
	   </div>
   </form>
    </section>
