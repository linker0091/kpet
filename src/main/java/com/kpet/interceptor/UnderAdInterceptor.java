...
@Log4j
// 관리자 로그인 인터셉터 클래스
public class UnderAdInterceptor extends HandlerInterceptorAdapter{
	
	private static final Logger logger = LoggerFactory.getLogger(UnderAdInterceptor.class);
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        if (admin != null) {  // 관리자 객체가 null이 아닌 경우
            ...
            if (position.equals("super_admin") || position.equals("middle_admin") || position.equals("under_admin")) {  // 관리자 권한이 있는 경우
